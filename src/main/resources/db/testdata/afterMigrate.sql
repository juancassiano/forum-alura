...
insert into topico(id,codigo, titulo, mensagem, status, autor_id, curso_id) values(1,'8dfd2c8f-e59e-4f75-8081-d2009d9c1b7a', 'uso correto de Records', 'Meu record está implementado corretamente?','NAO_RESPONDIDO', 1, 1);
insert into topico(id,codigo, titulo, mensagem, status, autor_id, curso_id) values(2,'0c193ef9-7ed6-4ffb-b547-6fb642b63433', 'Bootstrap ou Tailwind', 'Qual CSS usar?','NAO_RESPONDIDO', 1, 2);
insert into topico(id,codigo, titulo, mensagem, status, autor_id, curso_id) values(3,'bc263376-6be9-468a-bf9f-067bfa7a202f', 'Spring JPA com Flyway', 'Estou com problemas para criar as migrations','NAO_RESPONDIDO', 2, 1);
